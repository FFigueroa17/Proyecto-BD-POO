    ...
    public partial class Reservas : Form
    {
        ...
        public string Flag(DateTime prueba1, DateTime prueba2, string id)
        {
            ...
            using (SqlConnection connection = new SqlConnection(cadena)){
                ...
                string query = "select count(*) 'Conteo' from RESERVA WHERE id_ejemplar = '" +id + "' AND CONVERT(datetime,'" +prueba1+ "',103) BETWEEN fecha_hora_prestamo AND fecha_hora_devolucion";
